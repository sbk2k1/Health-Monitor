...
export default function Api(props) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await onPostData("sql/connections/" + props.match.params.name, {
                url: url,
                requestType: method,
                threshold: threshold,
            });
                        ...
                        {active.current && (
                            <div className="data">
                                ...
                                <div className="details">
                                    <h3>Graph For</h3>
                                    <br />
                                    <p><strong>URL:</strong> {active.current.database}</p>
                                    <p><strong>Method:</strong> {active.current.query}</p>
