    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route exact path="/dashboard/api/:name" component={loadable(() => import("./pages/dashboard/api/api"))} />
          <Route exact path="/dashboard/sql/:name" component={loadable(() => import("./pages/dashboard/sql/sql"))} /> 
